...
class Html 
{
	...
	public static $tag = [
		...
		'ul', 'ol', 'li', 'dd', 'dl', 'dt', 'span', 'strong', 'i', 'q', 's', 'u', 'b',
		...
		// Form Element
		'form', 'button', 'fieldset', 'legend', 'textarea', 'select', 'optgroup', 'option', 'label', 'small', 'error', 'required', 'datalist', 'multi-input',
		// To do checkbox, file, radio, select etc.	
		// Vue Template Components
		'FullCalendar', 'template', 'vue-editor', 'paginate', 'paginate_links'
	];
